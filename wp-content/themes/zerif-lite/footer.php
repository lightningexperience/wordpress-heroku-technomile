	...
	<div class="container">
		...
		<?php
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="http://themeisle.com/themes/zerif-lite/"'.$attribut_new_tab.' rel="nofollow"></a>'.__('','Heroku').'<a class="zerif-copyright" href="http://heroku.com/"'.$attribut_new_tab.' rel="nofollow"> </a></div>';
